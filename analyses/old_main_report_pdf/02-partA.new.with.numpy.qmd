...
### Create violinplot for each tissue type for `r rarget_gene` based on GTEX data ###
...
## Summary cell line selections

Gene `r target_gene` is particularly high expressed in target_tissue. Clustering of depmap scores suggest that the following genes have functional similarities. This may mean that they act in either the same pathway or paralell pathways with orthologus function. 
...
This section is designed to help you come to a conclusion and decide on what action to take next. 

- [x] Are you satisfied with the tissue specificity of `r target_gene`?
- [ ] Do you have any reason to believe that transcript-levels and protein expreesion d on not correlate for `r target_gene`?
- [ ] Do you have any indications that modulating of `r target_gene` has toxic effects? If you are unsure, would you like us to walk you through options regarding assessing toxicity?
- [ ] Would you like us to recommend alternative targets that are likely acting in the same pathway? This may also help you in identifiying a precise mechanism of action for `r target_gene`.
- [ ] Would you like additional advice on functional data on MOA inference. We might be able to help you in assessing electronic health records (EHR), biobank data, GWAS/MR repositories, clinical trials, etc. 